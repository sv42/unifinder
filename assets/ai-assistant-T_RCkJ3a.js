import{a as l,w as j,p as t}from"./chunk-EF7DTUVF-DePYFLeH.js";import{s as $}from"./supabase-lbAFZqEE.js";import{L as N}from"./Layout-CFnhGHKA.js";import"./Navbar-BN-7-YAR.js";import"./Footer-CXkfyUfl.js";const _=()=>{const[v,p]=l.useState(!1),u=l.useCallback(async()=>{try{const{data:o,error:a}=await $.from("universities").select(`
          *,
          programs (*)
